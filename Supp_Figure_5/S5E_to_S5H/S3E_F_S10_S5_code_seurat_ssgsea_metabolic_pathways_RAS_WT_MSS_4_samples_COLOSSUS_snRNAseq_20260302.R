################################################################################
# Figure Panels : Supplementary Figures 5E–5H (also S5Q)
# Description  : Seurat scRNA-seq analysis of public dataset GSE200997. Runs
#                escape/ssGSEA and generates geyser + cell-type expression
#                plots for the same gene sets as S5A-D in an independent cohort.
# Input data   : GSE200997 scRNA-seq Seurat object
#                c2.cp.kegg_legacy.v2024.1.Hs.symbols.gmt
# Output       : S5E_..._geyserEnrichment_scRNAseq_GSE200997.pdf
#                S5F_..._GLS_GLUL_expression.pdf
#                S5G_..._TCA_genes_expression.pdf
#                S5H_..._Alanine_Aspartate_genes.pdf
#                S5Q_..._EIF4B_expression.pdf
...
# Date         : March 2026
# Note         : Same script as S5A-D — produces GSE200997 panels when the
#                GSE200997 Seurat object is used as input.
################################################################################
