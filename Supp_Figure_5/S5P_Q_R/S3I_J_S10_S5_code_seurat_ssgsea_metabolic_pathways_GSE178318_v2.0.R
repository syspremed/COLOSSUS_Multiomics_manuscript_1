################################################################################
# Figure Panel  : Supplementary Figure 5R (EIF4B – GSE178318)
# Description   : EIF4B geyser enrichment plot in GSE178318 scRNA-seq.
#                 Part of the three-dataset EIF4B validation (5P, 5Q, 5R).
# Input data    : GSE178318 Seurat object
# Output        : S5R_..._EIF4B_GSE178318.pdf
# R packages    : escape, Seurat, qusage, ggplot2
