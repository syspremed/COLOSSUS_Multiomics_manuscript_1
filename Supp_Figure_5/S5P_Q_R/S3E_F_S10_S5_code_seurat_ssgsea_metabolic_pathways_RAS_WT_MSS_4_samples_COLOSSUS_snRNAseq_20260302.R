################################################################################
# Figure Panels : Supplementary Figures 5P, 5Q, 5R (EIF4B panels)
# Description  : EIF4B expression across cell types in three independent
#                scRNA-seq/snRNA-seq datasets:
#                5P – COLOSSUS snRNA-seq (RAS-WT, 4 samples)
#                5Q – GSE200997 scRNA-seq
#                5R – GSE178318 scRNA-seq
#                Same Seurat pipeline; select the relevant dataset as input.
# Input data   : Dataset-specific Seurat objects (see note)
#                c2.cp.kegg_legacy.v2024.1.Hs.symbols.gmt
# Output       : S5P/Q/R_..._EIF4B_expression_cell_types.pdf
...
# Date         : March 2026
# Note         : Set input Seurat object path to the relevant dataset.
################################################################################
