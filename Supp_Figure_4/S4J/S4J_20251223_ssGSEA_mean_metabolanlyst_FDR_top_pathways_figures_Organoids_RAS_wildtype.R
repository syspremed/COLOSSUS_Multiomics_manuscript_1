################################################################################
# Figure Panel : Supplementary Figure 4J
# Description  : ssGSEA scatter + boxplot for 3 selected RAS-wildtype organoid
#                lines vs MetaboAnalyst-enriched pathways.
# Input data   : LMO organoid expression (3 RAS-wildtype selected lines)
#                kegg_legacy gmt
# Output       : S4J_..._LMO_3_organoids_RAS_wt_Combined_Panels_AB.pdf
...
#    "KEGG_FATTY_ACID_BIOSYNTHESIS",
  ...
  Metabolomics_pvalue = c(
    0.0052456,   # Alanine, aspartate and glutamate
    0.0076762,  # Glyoxylate and dicarboxylate
   0.38332,  # Biosynthesis of unsaturated fatty acids
    0.18132,  # Butanoate
    0.23447,   # Citrate cycle (TCA)
    0.079797,    # Arginine and proline
    0.26476,    # Pyruvate
    0.23676,   # Glycine, serine and threonine (NEW)
   # 0.03034,     # Fatty acid biosynthesis (NEW)
    0.61341      # Purine metabolism (NEW)
  ),
  Metabolomics_FDR = c(
    0.083929,  # Alanine, aspartate and glutamate
    0.10235,   # Glyoxylate and dicarboxylate
    0.98921,   # Biosynthesis of unsaturated fatty acids
    0.88253,   # Butanoate
    0.88253,    # Citrate cycle (TCA)
    0.63838,    # Arginine and proline
    0.88253,    # Pyruvate
    0.95386,    # Glycine, serine and threonine (NEW)
   # 0.29065,     # Fatty acid biosynthesis (NEW)
    1       # Purine metabolism (NEW)
  ),
  Impact = c(
    0.39744,     # Alanine, aspartate and glutamate
    ...
    0.0283,     # Pyruvate
    0.07426,     # Glycine, serine and threonine (NEW)
 #   0.01473,     # Fatty acid biosynthesis (NEW)
    0      # Purine metabolism (NEW)
  ),
  Total_compounds = c(28, 36, 32, 15, 20, 36, 23, 33, 70),
  Hits = c(3, 1, 3, 1, 1, 2, 1, 1, 1),
...
expr_file <- "20251224_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_genes.txt"

gmt_file  <- "c2.cp.kegg_legacy.v2024.1.Hs.symbols.gmt"

out_gct   <- "20251224_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_genes_GSVA_ssGSEA_results_KEGG_Legacy.gct"
...
write.table(GSVA_RNAseq_m, "20251224_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_genes_Metabolanalyst_FDR_ssGSEA_top_pathways_Pathway_Distribution_data.txt", sep="\t", quote=FALSE, row.names=TRUE)
...
# Save Panel B
ggsave("S4J_20260322_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_RAS_wt_genes_Metabolanalyst_FDR_ssGSEA_top_pathways_Pathway_Distribution_Boxplots.pdf", 
 panel_b_alt, width = 12, height = 7, dpi = 300)

write.table(long_data[,1:3],"S4J_20260322_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_RAS_wt_genes_Metabolanalyst_FDR_ssGSEA_top_pathways_selected_metabolites_enriched_violin_plot_GSVA_ssGSEA_ordered_scores.txt", sep = "\t", quote = FALSE, row.names = FALSE)

cat("✓ Panel B saved: 20251224_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_genes_Metabolanalyst_FDR_ssGSEA_top_pathways_Pathway_Distribution_Boxplots.pdf\n")
...
ggsave("S4J_20260322_GSE204805_vsd_1331_322_399_LMO_organoids_Basale_RAS_wt_genes_Metabolanalyst_FDR_ssGSEA_top_pathways_ssGSEA_Combined_Panels_AB.pdf", final_plot, 
