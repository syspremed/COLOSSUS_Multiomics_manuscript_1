################################################################################
# Figure Panel : Supplementary Figure 4D
# Description  : ssGSEA validation in TCGA COAD RAS-wildtype tumours.
#                Mirror of S4C for the wildtype comparison arm.
# Input data   : TCGA HiSeqV2 expression matrix (RAS-wildtype subset)
#                kegg_legacy gmt
# Output       : S4D_..._TCGA_RAS_WILDTYPE_GSVA_ssGSEA_top_pathways_Boxplots.pdf
...
reference_file <- read.delim(
  "tcga_coadread_pancanatlas_RAS_wildtype_MSS_TCGA_barcodes.txt",
  stringsAsFactors = FALSE
)
...
#write.table(GSVA_RNAseq_m, "20251218_TCGA_HiSeqV2_RAS_WILDTYPE_GSVA_ssGSEA_top_pathways_Pathway_Distribution_data.txt", sep="\t", quote=FALSE, row.names=TRUE)
...
# Save figure to PDF.
ggsave("S4D_20251218_TCGA_HiSeqV2_RAS_WILDTYPE_GSVA_ssGSEA_top_pathways_Pathway_Distribution_Boxplots_violin.pdf", 
...
# Save Panel B
ggsave("S4D_20251218_TCGA_HiSeqV2_RAS_WILDTYPE_GSVA_ssGSEA_top_pathways_Pathway_Distribution_Boxplots_ordinary.pdf", 
 panel_b_alt, width = 12, height = 7, dpi = 300)

write.table(long_data[,1:3],"S4D_20260322_TCGA_HiSeqV2_RAS_WILDTYPE_GSVA_ssGSEA_top_pathways_selected_metabolites_enriched_violin_plot_GSVA_ssGSEA_ordered_scores.txt", sep = "\t", quote = FALSE, row.names = FALSE)
